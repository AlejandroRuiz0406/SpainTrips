...
export default {
    ...
    methods: {
        ...
        async obtenerPuntos() {
            try {
                const userRes = await axios.get(`https://spaintrips-production.up.railway.app/api/usuarios/${this.userId}`);
                this.puntos = userRes.data.puntos || 0;

                const recompensasRes = await axios.get(`https://spaintrips-production.up.railway.app/api/usuarios/${this.userId}/recompensas`);
        ...
        async obtenerReservas() {
            try {
                const res = await axios.get(`https://spaintrips-production.up.railway.app/api/mis-reservas/${this.userId}`);
        ...
        async obtenerPerfil() {
            try {
                const res = await axios.get(`https://spaintrips-production.up.railway.app/api/usuarios/${this.userId}`);
        ...
        async actualizarPerfil() {
            try {
                ...
                await axios.put(`https://spaintrips-production.up.railway.app/api/usuarios/${this.userId}`, payload);
        ...
        async cargarFavoritos() {
            try {
                const res = await axios.get(`https://spaintrips-production.up.railway.app/api/favoritos?usuario=${this.userId}`);
        ...
        eliminarFavorito(id) {
            axios.delete(`https://spaintrips-production.up.railway.app/api/favoritos/${id}`)
                .then(() => {
        ...
        async canjearRecompensa() {
            try {
                ...
                const res = await axios.post('https://spaintrips-production.up.railway.app/api/recompensas', {
        ...
        async obtenerCatalogo() {
            try {
                const res = await axios.get('https://spaintrips-production.up.railway.app/api/recompensas'); // devuelve solo recompensas sin usuario
        ...
        async canjearRecompensaDesdeCatalogo(id) {
            try {
                await axios.put(`https://spaintrips-production.up.railway.app/api/recompensas/${id}/canjear`);
