...
export default {
    ...
    setup() {
        ...
        const reservar = async (idDestino) => {
            ...
            try {
                await axios.post('spaintrips-production.up.railway.app/api/reservas', {
        ...
        const cargarVuelos = async (idDestino) => {
            try {
                const res = await axios.get(`spaintrips-production.up.railway.app/api/vuelos/destino/${idDestino}`)
        ...
        const abrirModalReserva = async (dest) => {
            ...
            try {
                const res = await axios.get(`spaintrips-production.up.railway.app/api/vuelos/destino/${dest.ID_destino}`)
                vuelos.value = res.data
            } catch {
                vuelos.value = []
            }
        ...
        const confirmarReserva = async () => {
            ...
            try {
                ...
                const resConfirmacion = await axios.post('spaintrips-production.up.railway.app/api/reservas', payload);
